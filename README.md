...
- 招待リンクを開いた端末に既存データがある場合は、同期前に「共有の内容に入れ替える／今の内容も合わせる」を選択
...
現在は77件の定番料理を使う検証版です。栄養値は食品ごとの一般的な参考値と基本調味料の仮定から丸めた目安であり、商品表示や医療・栄養指導の代わりにはなりません。賞味期限とアカウントにはまだ対応していません。複数端末間の同期は、限定リンクを知っている二人で使う簡易共有に限って対応しています。
